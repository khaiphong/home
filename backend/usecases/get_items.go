...
/*
	Home usecases may contain coded (Facebook clones), (Miss U / Twitter
	clone) messages for the user and/or the user's messages to the Twitter
	clone. It also includes the list of displayed pages to the user's
	Activities, Relationships, Places, Mu Command, EIP, and anything relating
	to MyIntuition for Big-Data AI.
*/